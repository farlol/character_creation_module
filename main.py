...
def special(char_name: str, char_class: str) -> str:
    """Calculate special ability figures."""
    if char_class == 'warrior':
    ...
    return 'Спец умение не удалось'


def start_training(char_name: str, char_class: str) -> str:
    """Run all standard functions for attack, defense or special action."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Input and define character class."""
    approve_choice: str = ''
    char_class: str = ''
